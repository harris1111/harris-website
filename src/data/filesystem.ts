  ...
  children: [
    {
      ...
      content: () => [
        ...
        "From: root@harris-cv",
        "To: visitor",
        "Subject: Penetration Test Authorization",
        "",
        "You found the hidden file. Good instincts.",
        "",
        "This server has been flagged for a pentest.",
        "Your mission: hack this machine.",
        "",
        "Run: hack",
        "",
        "If you're skilled enough to break in,",
